      ...
      <div class="sacr-content body-container">
        <div class="sacr-about py-10">
          <div class="sacr-area breakdown">
            ...
            <p>
              The Rig Interface extension is an API extension which provides
              utilities for working with and creating new and using Python based
              rig interfaces such as those found in use by{" "}
              <a href="/rig/sakura-character-rig" class="link">
                my own SACR project
              </a>
              ,{" "}
              <a
                href="https://www.youtube.com/watch?v=XZZUk8BqVOE"
                class="link"
                target="_blank"
              >
                Endertainer's MCS2 rig
              </a>
              ,{" "}
              <a
                href="https://www.youtube.com/watch?v=8mnU203_S_s"
                class="link"
                target="_blank"
              >
                Timy's Character Rig V7
              </a>
              , and several other advanced rigs. This addon is created in
              Blender's Python API and included operators include:
            </p>
            ...
            <p>
              This extension is very much an ongoing project, and will continue
              to get new features alongside releases of different rigs by
              Sakura, namely the{" "}
              <a href="/rig/sakura-character-rig">Advanced Character Rig</a>, of
              which this extension is packaged with the UI's for.
            </p>
            <h2 class="my-5">What's the plan for the future?</h2>
            <p>
              As mentioned, this project is ongoing, and has no end in sight.
              Eventually I want to integrate the ability to easily add UI
              scripts as well as many more utilities useful for Minecraft based
              creations within Blender. A portion of that goal has already been
              realized, as it is extremely easy to add existing, already built
              UI's into the addon as tested with{" "}
              <a
            ...
            <div class="sacr-downloads">
              <div class="branch stable">
                ...
                <div class="dwn-btn-contain">
                  <a class="btn" target="_blank" href={stable.blender_ext}>
                  ...
                  <a
                    class="btn"
                    target="_blank"
                    href={`${stable.github}/${downloadPath}${stableInfo[stableIndex()].git_tag}/${stableInfo[stableIndex()].fileName}`}
                  >
                    Mirror: {stable.version}
          ...
          <div class="rig-gui sacr-area">
            ...
            <p>
              This UI works best on SACR Rigs, a lightweight, feature packed and
              versitile rig which allows for easy customization while being easy
              to run
            </p>
            <br />
            <div class="join-server">
